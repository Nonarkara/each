/* demo.js — Ikigai Finance Engine mock-up dataset.
   One click loads a coherent Thai AI-startup workspace. THB throughout. */
(function (global) {
  'use strict';
  ...
  function build() {
    return {
      onboarded: true,
      company: {
        legalName: 'AXIOM DECISION SYSTEMS CO., LTD.', reg: '0105566000000',
        name: 'Axiom Decision Systems', country: 'Thailand',
        industry: 'Decision systems / AI consulting', founded: '2024-09-01',
        address: '88 Silom Rd, Bang Rak, Bangkok 10500',
      },
      currency: 'THB', asOf: '2026-06-27',
      foundingCapital: [
        { id: 'fc1', source: 'Registration paperwork', taxId: '0105566000000', amount: 1000000, currency: 'THB', date: '2024-09-01', note: 'Paid-up capital' },
      ],
      // Month expenses — Thai startup, THB.
      expenses: [
      ...
      gmailConnected: true, gmailImported: 5,
      employees: [],
      // AI operators — the signature framing, repriced in THB.
      aiEmployees: [
      ...
      // The Ikigai book — 6 projects. commissioned→doing, pipeline→backlog.
      projects: [
        { id:'proj_1', title:'TKCx New Chapter', clientId:'TKC', client:'Turnkey Communications PCL',
          totalValue:1000000, received:97000, taxDeducted:3000, receivedDate:'2026-06-15',
          status:'doing', dealStatus:'commissioned', scenarioTier:1, currency:'THB', owner:'Founder',
          checklist:[{k:'Kickoff with TKC',done:true},{k:'Discovery & scope',done:true},{k:'Build phase',done:false},{k:'Deploy & handoff',done:false}],
          notes:[{t:'First tranche received. 3% withholding tax recorded against revenue.',at:'2026-06-15'}], files:['tkcx-sow.pdf'] },
        { id:'proj_2', title:'Horizon Assessment', clientId:'EDA', client:'EDA (Thailand) Co., Ltd.',
          totalValue:500000, received:0, taxDeducted:0, receivedDate:'',
          status:'doing', dealStatus:'commissioned', scenarioTier:1, currency:'THB', owner:'Founder',
          checklist:[{k:'Stakeholder interviews',done:false},{k:'Assessment report draft',done:false}], notes:[], files:[] },
        { id:'proj_3', title:'Bundle: AI Sovereignty, SME Platform, Zuno', clientId:'EDA', client:'EDA (Thailand) Co., Ltd.',
          totalValue:1000000, received:0, taxDeducted:0, receivedDate:'',
          status:'backlog', dealStatus:'pipeline', scenarioTier:2, currency:'THB', owner:'Founder',
          checklist:[{k:'Proposal submitted',done:true},{k:'Awaiting EDA decision',done:false}], notes:[], files:[] },
        { id:'proj_4', title:'Chula Super Dashboard', clientId:'Chula', client:'Chulalongkorn University',
          totalValue:1000000, received:0, taxDeducted:0, receivedDate:'',
          status:'backlog', dealStatus:'pipeline', scenarioTier:2, currency:'THB', owner:'Founder',
          checklist:[{k:'Scoping workshop',done:false}], notes:[], files:[] },
        { id:'proj_5', title:'Praram 9 AI Readiness', clientId:'PR9', client:'Praram 9 Hospital',
          totalValue:2000000, received:0, taxDeducted:0, receivedDate:'',
          status:'backlog', dealStatus:'pipeline', scenarioTier:2, currency:'THB', owner:'Founder',
          checklist:[{k:'RFP response sent',done:true}], notes:[], files:[] },
        { id:'proj_6', title:'TKC AI Pilot', clientId:'TKC', client:'Turnkey Communications PCL',
          totalValue:5000000, received:0, taxDeducted:0, receivedDate:'',
          status:'backlog', dealStatus:'pipeline', scenarioTier:3, currency:'THB', owner:'Founder',
          checklist:[{k:'Qualify opportunity',done:false}],
          notes:[{t:'Stretch deal. Would 5x the book if it lands.',at:'2026-06-20'}], files:[] },
      ],
      accounts: [
  ...
  global.Demo = { build, load: () => global.Data.Store.load(build()) };
})(window);
